...
class SettingsWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        tk.Entry(self, textvariable=self.prob_var).grid(row=row, column=1, padx=10)
        ...
        tk.Entry(self, textvariable=self.assoc_var).grid(row=row, column=1, padx=10)
        ...
        tk.Entry(self, textvariable=self.active_var).grid(row=row, column=1, padx=10)
        ...
        tk.Entry(self, textvariable=self.year_var).grid(row=row, column=1, padx=10)
